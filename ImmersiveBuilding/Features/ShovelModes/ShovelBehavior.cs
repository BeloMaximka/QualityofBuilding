...
public class ShovelBehavior : CollectibleBehavior
{
    ...
    )
    {
        ...
        int selectedMode = slot.Itemstack.Attributes.GetInt(toolModeAttributeName);
    ...
    {
        return slot.Itemstack.Attributes.GetInt(toolModeAttributeName);
    }

    public override void SetToolMode(ItemSlot slot, IPlayer byPlayer, BlockSelection blockSelection, int toolMode)
    {
        slot.Itemstack.Attributes.SetInt(toolModeAttributeName, toolMode);
    }
