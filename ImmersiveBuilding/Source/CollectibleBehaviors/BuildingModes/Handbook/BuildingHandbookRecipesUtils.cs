...
namespace ImmersiveBuilding.Source.CollectibleBehaviors.BuildingModes.Handbook;
...
public static class BuildingHandbookRecipesUtils
{
    ...
    {
        List<SkillModeBuildingRecipe> recipes = api.ModLoader.GetModSystem<ImmersiveBuildingModSystem>().BuildingRecipes;
