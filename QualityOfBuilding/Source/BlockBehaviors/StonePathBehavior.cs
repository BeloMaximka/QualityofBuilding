...
namespace QualityOfBuilding.Source.BlockBehaviors;

public class StonePathBehavior(Block block) : BlockBehavior(block)
{
        ...
        if (forPlayer.InventoryManager.ActiveHotbarSlot?.Itemstack?.HasMode(ShovelBehavior.StonePathToolModeCode) == true)
        {
            ...
            [
                ...
                new()
                {
                    ...
                    ActionLangCode = "interactionhelp-build-stairs",
